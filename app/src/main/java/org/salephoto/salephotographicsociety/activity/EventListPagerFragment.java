...
public class EventListPagerFragment extends AbstractListPagerFragment {
    @Override
    public void onViewCreated(final View view, final Bundle savedInstanceState) {
        ...
        final EventListPagerAdapter pagerAdapter = new EventListPagerAdapter(getChildFragmentManager());
        viewPager.setAdapter(pagerAdapter);
        viewPager.setCurrentItem(1);
    }

    private class EventListPagerAdapter extends ListPagerAdapter {
