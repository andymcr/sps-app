...
public class TalkListPagerFragment extends AbstractListPagerFragment {
    @Override
    public void onViewCreated(final View view, final Bundle savedInstanceState) {
        ...
        final TalkListPagerAdapter pagerAdapter = new TalkListPagerAdapter(getChildFragmentManager());
        viewPager.setAdapter(pagerAdapter);
        viewPager.setCurrentItem(1);
    }

    private class TalkListPagerAdapter extends ListPagerAdapter {
        public TalkListPagerAdapter(FragmentManager fm) {
            super(fm);
        }
